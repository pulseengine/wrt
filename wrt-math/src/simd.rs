...
//! SIMD (Single Instruction, Multiple Data) operations for WebAssembly v128 types.
//!
//! This module provides a high-level mathematical interface for WebAssembly SIMD
//! operations, delegating the actual implementation to the platform-specific SIMD
//! providers in wrt-platform.
...
impl SimdOperations {
    ...
    pub fn i8x16_shuffle(&self, a: &[u8; 16], b: &[u8; 16], indices: &[u8); 16]) -> Result<[u8; 16]> {
