...
mod tests {
    ...
    fn test_without_debug_info() {
        ...
        // With line-info but without debug-info, this should work if line-info is enabled
        let _has_debug = debug_info.has_debug_info();
    }
}
...
mod runtime_tests {
    ...
    fn test_variable_formatting() {
        use crate::runtime_api::VariableValue;
        use crate::runtime_vars::ValueDisplay;
        use crate::parameter::BasicType;
