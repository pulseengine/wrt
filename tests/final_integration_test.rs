...
mod tests {
    use wrt::{
        ...
        binary,
        component::{FormatComponent, FormatComponentType},
        compression::{rle_decode, rle_encode},
        ...
        Memory, Table, Global, PAGE_SIZE,
        
        // Error handling from wrt-error
        Error, ErrorCategory, Result,
        
        // Logging functionality from wrt-logging
        LogLevel, LogOperation,
        
        // Sync primitives from wrt-sync
        sync::{AtomicBool, Mutex, RwLock},
        
        // Main WRT functionality
        new_engine, new_module, new_memory, new_table, new_global,
        module::{Module, ExportKind},
