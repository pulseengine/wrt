...
use wrt_foundation::{
    bounded::BoundedVec, budget_aware_provider::CrateId, managed_alloc, safe_managed_alloc,
    WrtError, WrtResult,
};
...
mod feature_flag_tests {
    ...
    #[cfg(all(not(feature = "stdMissing message"), not(feature = "safety-criticalMissing messageMissing messageMissing message")))]
    #[test]
