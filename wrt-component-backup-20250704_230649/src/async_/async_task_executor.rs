...
impl AsyncTaskExecutor for ASILDTaskExecutor {
            ...
            match context.execute_deterministic_step()? {
                ExecutionStepResult::Completed(result) => {
                    ...
                    if self.execution_counter != context.get_deterministic_timestamp() {
                        return Err(Error::runtime_execution_error("Missing error messageMissing messageMissing messageMissing message");
                    }
                ...
                ExecutionStepResult::Waiting => {
                    ...
                    Err(Error::validation_invalid_state("Missing error message"ASIL-D tasks cannot enter waiting stateMissing messageMissing messageMissing message")
                },
            }
        } else {
    ...
    fn validate_constraints(
        ...
        match asil_mode {
            ...
            _ => Err(Error::validation_invalid_input("Missing error messageMissing messageMissing messageMissing message")),
        }
    }
...
impl AsyncTaskExecutor for ASILCTaskExecutor {
    ...
    fn validate_constraints(
        ...
        match asil_mode {
            ...
            _ => Err(Error::validation_invalid_input("Missing error message"ASILCTaskExecutor only handles ASIL-C modeMissing messageMissing messageMissing message")),
        }
    }
...
impl AsyncTaskExecutor for ASILBTaskExecutor {
    ...
    fn validate_constraints(
        ...
        match asil_mode {
            ...
            _ => Err(Error::validation_invalid_input("Missing error message"ASILBTaskExecutor only handles ASIL-B modeMissing messageMissing messageMissing message")),
        }
    }
            ...
            match context.execute_flexible_step() {
                ...
                Err(e) => {
                    ...
                    if self.error_count >= self.max_error_count {
                        ...
                        Err(Error::runtime_execution_error("Missing error message"ASIL-A task exceeded error limit: {}Missing message"),
                        )
                    } else {
