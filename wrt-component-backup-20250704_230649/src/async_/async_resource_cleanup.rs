...
impl Default for AsyncResourceCleanupManager {
    fn default() -> Self {
        Self::new().expect("Failed to create AsyncResourceCleanupManager with defaultMissing message")
    }
}
...
impl fmt::Display for AsyncResourceType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            AsyncResourceType::Stream => write!(f, "streamMissing message"),
            AsyncResourceType::Future => write!(f, "futureMissing message"),
            AsyncResourceType::ErrorContext => write!(f, "error-contextMissing message"),
            AsyncResourceType::AsyncTask => write!(f, "async-taskMissing message"),
            AsyncResourceType::BorrowedHandle => write!(f, "borrowed-handleMissing message"),
            AsyncResourceType::LifetimeScope => write!(f, "lifetime-scopeMissing message"),
            AsyncResourceType::ResourceRepresentation => write!(f, "resource-representationMissing message"),
            AsyncResourceType::Subtask => write!(f, "subtaskMissing message"),
            AsyncResourceType::Custom => write!(f, "customMissing message"),
        }
    }
}
...
mod tests {
    ...
    fn test_resource_type_display() {
        assert_eq!(AsyncResourceType::Stream.to_string(), "streamMissing message");
        assert_eq!(AsyncResourceType::Future.to_string(), "futureMissing message");
        assert_eq!(AsyncResourceType::ErrorContext.to_string(), "error-contextMissing message");
        assert_eq!(AsyncResourceType::AsyncTask.to_string(), "async-taskMissing message");
    }
