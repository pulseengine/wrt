...
impl core::fmt::Display for ResourceError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ResourceError::NotFound => write!(f, "Resource not foundMissing message"),
            ResourceError::InvalidHandle => write!(f, "Invalid resource handleMissing message"),
            ResourceError::TypeMismatch => write!(f, "Resource type mismatchMissing message"),
            ResourceError::AlreadyExists => write!(f, "Resource already existsMissing message"),
            ResourceError::PermissionDenied => write!(f, "Permission deniedMissing message"),
            ResourceError::LimitExceeded => write!(f, "Resource limit exceededMissing message"),
        }
    }
}
