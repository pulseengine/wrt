...
fn convert_format_valtype_to_valuetype(format_val_type: &FormatValType<ComponentProvider>) -> Result<ValueType> {
    match format_val_type {
        ...
        _ => Err(Error::unimplemented("Missing error message"Component not foundMissing messageMissing messageMissing message")),
    }
}
...
pub fn value_type_to_format_val_type(value_type: &ValueType) -> Result<FormatValType<ComponentProvider>> {
    match value_type {
        ...
        ValueType::FuncRef => Err(Error::runtime_execution_error("Missing error message".to_string(),
            ),
        )),
...
pub fn runtime_to_format_extern_type(
    ...
    match types_extern_type {
        ...
        WrtExternType::Table(table_type) => Err(Error::runtime_execution_error("Missing error message".to_string(),
        )),
        ...
        WrtExternType::Global(global_type) => Err(Error::runtime_execution_error("Missing error message".to_string(),
        )),
...
pub fn types_componentvalue_to_core_value(
    ...
    match component_value {
        ...
        _ => Err(Error::runtime_execution_error("Missing error message".to_string(),
            ),
        )),
    }
}
...
pub fn complete_types_to_format_extern_type(
    ...
    match types_extern_type {
        ...
        wrt_foundation::WrtExternType::Table(table_type) => Err(Error::runtime_execution_error("Missing error message".to_string(),
        )),
        ...
        wrt_foundation::WrtExternType::Global(global_type) => Err(Error::runtime_execution_error("Missing error message".to_string(),
        )),
