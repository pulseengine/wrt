...
impl TryFrom<ComponentTypeDefinition> for RuntimeComponentType {
    ...
    fn try_from(type_def: ComponentTypeDefinition) -> Result<Self> {
        match type_def {
            ...
            _ => Err(Error::validation_error("Missing error message"Expected Component type definitionMissing messageMissing messageMissing message")),
        }
    }
}
...
impl TryFrom<ComponentTypeDefinition> for RuntimeInstanceType {
    ...
    fn try_from(type_def: ComponentTypeDefinition) -> Result<Self> {
        match type_def {
            ...
            _ => Err(Error::validation_error("Missing error message"Expected Instance type definitionMissing messageMissing messageMissing message")),
        }
    }
}
