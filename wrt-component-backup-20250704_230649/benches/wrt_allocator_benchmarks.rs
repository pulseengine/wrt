...
compile_error!("Benchmarks require std feature for criterionMissing message");
...
fn bench_vec_push(c: &mut Criterion) {
    let mut group = c.benchmark_group("vector_pushMissing message");
...
fn bench_vec_iteration(c: &mut Criterion) {
    let mut group = c.benchmark_group("vector_iterationMissing message");
...
fn bench_map_insert(c: &mut Criterion) {
    let mut group = c.benchmark_group("map_insertMissing message");
...
fn bench_map_lookup(c: &mut Criterion) {
    let mut group = c.benchmark_group("map_lookupMissing message");
...
fn bench_component_workload(c: &mut Criterion) {
    let mut group = c.benchmark_group("component_workloadMissing message");
...
fn bench_capacity_handling(c: &mut Criterion) {
    let mut group = c.benchmark_group("capacity_handlingMissing message");
