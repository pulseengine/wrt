...
pub trait ArcMemoryExt {
    ...
    fn read_bytes_safe(
        ...
        offset: u32,
        len: u32,
    ) -> Result<wrt_types::safe_memory::SafeStack<u8>, wrt_error::Error>;
    ...
    fn read_bytes(&self, offset: u32, len: u32) -> Result<Vec<u8>, wrt_error::Error>;

    /// Write bytes to memory
    fn write_bytes(&self, offset: u32, bytes: &[u8]) -> Result<(), wrt_error::Error>;

    /// Grow memory by a number of pages
    fn grow(&self, pages: u32) -> Result<u32, wrt_error::Error>;

    /// Read a 32-bit integer from memory
    fn read_i32(&self, addr: u32) -> Result<i32, wrt_error::Error>;

    /// Read a 64-bit integer from memory
    fn read_i64(&self, addr: u32) -> Result<i64, wrt_error::Error>;

    /// Read a 32-bit float from memory
    fn read_f32(&self, addr: u32) -> Result<f32, wrt_error::Error>;

    /// Read a 64-bit float from memory
    fn read_f64(&self, addr: u32) -> Result<f64, wrt_error::Error>;

    /// Read an 8-bit signed integer from memory
    fn read_i8(&self, addr: u32) -> Result<i8, wrt_error::Error>;

    /// Read an 8-bit unsigned integer from memory
    fn read_u8(&self, addr: u32) -> Result<u8, wrt_error::Error>;

    /// Read a 16-bit signed integer from memory
    fn read_i16(&self, addr: u32) -> Result<i16, wrt_error::Error>;

    /// Read a 16-bit unsigned integer from memory
    fn read_u16(&self, addr: u32) -> Result<u16, wrt_error::Error>;

    /// Read a 32-bit unsigned integer from memory
    fn read_u32(&self, addr: u32) -> Result<u32, wrt_error::Error>;

    /// Read a 64-bit unsigned integer from memory
    fn read_u64(&self, addr: u32) -> Result<u64, wrt_error::Error>;

    /// Read a 128-bit vector from memory
    fn read_v128(&self, addr: u32) -> Result<[u8; 16], wrt_error::Error>;

    /// Write a 32-bit integer to memory
    fn write_i32(&self, addr: u32, value: i32) -> Result<(), wrt_error::Error>;

    /// Write a 64-bit integer to memory
    fn write_i64(&self, addr: u32, value: i64) -> Result<(), wrt_error::Error>;

    /// Write a 32-bit float to memory
    fn write_f32(&self, addr: u32, value: f32) -> Result<(), wrt_error::Error>;

    /// Write a 64-bit float to memory
    fn write_f64(&self, addr: u32, value: f64) -> Result<(), wrt_error::Error>;

    /// Write an 8-bit integer to memory
    fn write_i8(&self, addr: u32, value: i8) -> Result<(), wrt_error::Error>;

    /// Write an 8-bit unsigned integer to memory
    fn write_u8(&self, addr: u32, value: u8) -> Result<(), wrt_error::Error>;

    /// Write a 16-bit signed integer to memory
    fn write_i16(&self, addr: u32, value: i16) -> Result<(), wrt_error::Error>;

    /// Write a 16-bit unsigned integer to memory
    fn write_u16(&self, addr: u32, value: u16) -> Result<(), wrt_error::Error>;

    /// Write a 32-bit unsigned integer to memory
    fn write_u32(&self, addr: u32, value: u32) -> Result<(), wrt_error::Error>;

    /// Write a 64-bit unsigned integer to memory
    fn write_u64(&self, addr: u32, value: u64) -> Result<(), wrt_error::Error>;

    /// Write a 128-bit vector to memory
    fn write_v128(&self, addr: u32, value: [u8; 16]) -> Result<(), wrt_error::Error>;
    ...
    ) -> Result<Value, wrt_error::Error>;

    /// Write standard WebAssembly value
    fn write_value(&self, addr: u32, value: Value) -> Result<(), wrt_error::Error>;
    ...
    fn read_values_as_safe_stack(
        ...
        value_type: wrt_types::types::ValueType,
        count: usize,
    ) -> Result<wrt_types::safe_memory::SafeStack<Value>, wrt_error::Error>;
}
