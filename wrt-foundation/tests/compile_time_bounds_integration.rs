...
///
/// Since validation is compile-time, this measures runtime allocation
/// performance to ensure the validation system doesn't add runtime overhead.
#[test]
fn test_no_runtime_overhead() {
    ...
    assert!(
        ...
        "Validation appears to add runtime overhead"
    );
}
