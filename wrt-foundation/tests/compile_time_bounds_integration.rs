...
fn test_compile_time_bounds_validator() {
    ...
    let validator1 = CompileTimeBoundsValidator::<1024, {CrateId::Foundation as usize}>::validate();
    assert_eq!(validator1.size(), 1024);
    assert_eq!(validator1.crate_id(), CrateId::Foundation as usize);
    
    let validator2 = CompileTimeBoundsValidator::<65536, {CrateId::Component as usize}>::validate();
