...
use wrt_foundation::allocator::{WrtVec, WrtHashMap, CrateId, CapacityError};
...
fn demo_foundation_integration() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut runtime_map: WrtHashMap<String, i32, {CrateId::Runtime as u8}, 256> = WrtHashMap::new();
