...
//! reducing waste from static allocation while maintaining no_std compatibility.
...
pub mod recommendations {
    ...
    pub const DEBUG_INFO: usize = size_classes::LARGE;     // 16KB for debug sections
}
...
macro_rules! sized_provider {
    ...
    (class: tiny) => { $crate::memory_sizing::TinyProvider::default() };
    (class: small) => { $crate::memory_sizing::SmallProvider::default() };
    (class: medium) => { $crate::memory_sizing::MediumProvider::default() };
    (class: large) => { $crate::memory_sizing::LargeProvider::default() };
    (class: xlarge) => { $crate::memory_sizing::XLargeProvider::default() };
    (class: huge) => { $crate::memory_sizing::HugeProvider::default() };
}
