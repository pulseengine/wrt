...
use crate::{
    ...
    budget_verification::{CRATE_BUDGETS, TOTAL_MEMORY_BUDGET, calculate_total_budget},
};
...
impl<const CAPACITY: usize, const ELEMENT_SIZE: usize> CollectionBoundsValidator<CAPACITY, ELEMENT_SIZE> {
...
mod compile_time_tests {
    ...
    const _TEST_COLLECTION: CollectionBoundsValidator<100, 64> = CollectionBoundsValidator::validate();
