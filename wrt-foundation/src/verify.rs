...
pub mod kani_verification {
    ...
    use crate::{
        ...
        bounded::{BoundedError, BoundedVec},
        safe_memory::{DefaultNoStdProvider, SafeMemoryHandler},
        types::ValueType,
    };
    ...
    impl AtomicMemory {
        fn new(initial: u32) -> Self {
            Self { value: core::sync::atomic::AtomicU32::new(initial) }
        }
