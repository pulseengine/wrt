...
use crate::{
    ...
    generic_memory_guard::{ManagedMemoryProvider, MemoryCoordinator, GenericMemoryGuard},
    generic_provider_factory::{ProviderFactory, GenericBudgetAwareFactory},
    memory_coordinator::{GenericMemoryCoordinator, CrateIdentifier, AllocationId},
...
pub type WrtMemoryGuard<const N: usize> = GenericMemoryGuard<NoStdProvider<N>, WrtMemoryCoordinator, CrateId>;

/// Global WRT memory coordinator instance
...
pub type WrtBudgetAwareFactory<const N: usize> = GenericBudgetAwareFactory<
    SizedNoStdProviderFactory<N>,
    WrtMemoryCoordinator,
    CrateId
>;

/// Main factory for WRT memory providers
pub struct WrtProviderFactory;

impl WrtProviderFactory {
    /// Create a budget-aware provider with specified size
