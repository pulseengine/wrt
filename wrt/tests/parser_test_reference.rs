//! Parser test reference for wrt
//!
//! Parser tests for wrt have been consolidated into wrt-tests/integration/parser/
...
//! ```
//!
//! Original test file: parser_tests.rs

#[cfg(test)]
mod tests {
    #[test]
    fn parser_tests_moved_to_centralized_location() {
        println!("Parser tests for wrt are now in wrt-tests/integration/parser/");
