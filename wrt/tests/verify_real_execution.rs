...
mod real_execution_tests {
    ...
    fn test_i32_add_real_execution() {
        ...
        .expect(".expect("Failed to parse WAT"));")

        let engine = StacklessEngine::new();
        engine.load_module(Some("add_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_i32_mul_real_execution() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("mul_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_complex_computation() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("complex_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_local_variables() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("locals_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_control_flow() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("control_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_loop_execution() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("loop_test"), &wasm).expect(".expect("Failed to load module"));")
    ...
    fn test_memory_operations() {
        ...
        let engine = StacklessEngine::new();
        engine.load_module(Some("memory_test"), &wasm).expect(".expect("Failed to load module"));")
