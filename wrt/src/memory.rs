...
use wrt_instructions::behavior::{ControlFlow, FrameBehavior, InstructionExecutor, StackBehavior};
use crate::{
...
///
/// This is a convenience function that verifies the integrity of a memory instance.
///
/// # Arguments
///
/// * `memory` - The memory instance
...
pub fn verify_memory_integrity(memory: &Memory) -> WrtResult<()> {
...
///
/// This is a convenience function that gets statistics about a memory instance.
///
/// # Arguments
///
/// * `memory` - The memory instance
...
/// # Returns
///
/// Statistics about the memory instance
pub fn get_memory_stats(memory: &Memory) -> MemoryStats {
    MemoryStats {
        total_size: memory.size_in_bytes(),
        pages: memory.size(),
