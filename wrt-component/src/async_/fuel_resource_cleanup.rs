...
mod tests {
    ...
    fn test_callback_priority() {
        ...
        context
            .register_callback(CleanupCallback::new(
                CleanupAction::Custom("low".to_owned()),
                10,
                1,
                false,
            ))
        ...
        context
            .register_callback(CleanupCallback::new(
                CleanupAction::Custom("high".to_owned()),
                100,
                1,
                false,
            ))
        ...
        context
            .register_callback(CleanupCallback::new(
                CleanupAction::Custom("medium".to_owned()),
                50,
                1,
                false,
            ))
    ...
    fn test_cleanup_guard() {
        let manager = Arc::new(Mutex::new(GlobalCleanupManager::new(10000).unwrap()));
