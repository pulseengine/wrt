...
use crate::prelude::*;
use super::{
    ResourceArena, ResourceTable, ResourceManager, SizeClassBufferPool, Resource, ResourceId
};
...
fn test_size_class_buffer_pool() {
    ...
    // Test several allocations of different sizes
...
fn test_performance_comparison() {
    ...
    println!("Improvement factor: {:.2}x", standard_duration.as_secs_f64() / optimized_duration.as_secs_f64());
}