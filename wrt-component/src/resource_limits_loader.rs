...
fn convert_to_asil_config(
    ...
    let execution_limits = ExecutionLimitsConfig {
        ...
        max_memory_usage:          limits
            .max_memory_usage
            .unwrap_or_else(|| ExecutionLimitsConfig::default_for_asil(asil_mode).max_memory_usage),
        max_stack_depth:           limits
            .max_call_depth
            .unwrap_or_else(|| ExecutionLimitsConfig::default_for_asil(asil_mode).max_stack_depth),
        ...
        max_async_operations:      ExecutionLimitsConfig::default_for_asil(asil_mode)
            .max_async_operations,
        max_waitables_per_task:    ExecutionLimitsConfig::default_for_asil(asil_mode)
            .max_waitables_per_task,
        max_concurrent_tasks:      ExecutionLimitsConfig::default_for_asil(asil_mode)
            .max_concurrent_tasks,
        max_yields_per_step:       ExecutionLimitsConfig::default_for_asil(asil_mode)
            .max_yields_per_step,
    };
