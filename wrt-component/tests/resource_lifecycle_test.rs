...
use wrt_component::{
    ...
    resource_lifecycle_management::{
        ...
        ResourceId, ResourceLifecycleManager, ResourceMetadata, ResourceType,
    },
...
fn test_handle_lifetime_tracking() {
    ...
    let result = with_lifetime_scope(&mut tracker, ComponentId(1), TaskId(1), |scope| {
        let borrowed = tracker
            .borrow_handle(&owned, ComponentId(2), scope)
            .unwrap();
