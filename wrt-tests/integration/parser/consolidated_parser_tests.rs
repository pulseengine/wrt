...
//!
//! This module consolidates all parser test functionality from across the WRT
//! project, eliminating duplication and providing comprehensive testing in a
//! single location.
...
pub fn create_multi_import_module() -> Vec<u8> {
    ...
    module.extend_from_slice(&[
        ...
        0x72, 0x65, 0x73, 0x6F, 0x75, 0x72, 0x63, 0x65, 0x2E, 0x63, 0x72, 0x65, 0x61, 0x74,
        0x65, // "resource.create"
...
mod comprehensive_parser_tests {
    ...
    fn test_comprehensive_module_parsing() {
        ...
        assert!(section_count >= 5); // At least type, import, function, export,
                                     // code sections
    }
...
mod performance_parser_tests {
    ...
    fn test_parser_performance() {
        ...
        assert!(
            duration.as_secs() < 1,
            "Parser performance regression detected"
        );
    }
