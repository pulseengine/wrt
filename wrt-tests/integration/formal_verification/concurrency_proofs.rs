...
pub fn verify_mutex_mutual_exclusion() {
    ...
    assert_eq!(
        final_value,
        shared_data
            .wrapping_add(operation1_increment)
            .wrapping_add(operation2_increment)
    );
}
...
pub fn property_count() -> usize {
    6 // verify_atomic_compare_and_swap, verify_atomic_fetch_and_add,
      // verify_mutex_mutual_exclusion, verify_rwlock_concurrent_reads,
      // verify_memory_ordering, verify_deadlock_prevention
}
