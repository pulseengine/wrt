...
// In a real implementation, this would be in
// wrt-component/src/type_conversion/registry.rs and other appropriate files,
// but this is just for validation of the design
...
impl ComponentLoader {
    pub fn new() -> Self {
        ...
        registry.register(
            |format: &FormatValType| -> Result<RuntimeValType, ConversionError> {
    ...
    ) -> Result<RuntimeValType, ConversionError> {
