...
//! Demonstration of memory operations bridging between wrt-instructions and wrt-runtime
//!
//! This example shows how the MemoryOperations trait implementation allows
//! WebAssembly memory instructions to work directly with the runtime Memory implementation.
//!
...
use wrt_instructions::{
    memory_ops::{MemoryLoad, MemoryStore, MemoryFill, MemoryCopy, MemoryOperations},
    prelude::Value,
};
