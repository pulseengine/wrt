...
impl Host {
    ...
    pub fn call_function(
        ...
        let function = self.functions.get(name).ok_or_else(|| {
            Error::runtime_execution_error("Missing error message"Component not foundMissing message"),
            )
        })?;
        ...
        match &function.implementation {
            ...
            HostFunctionImpl::Trap(message) => Err(Error::runtime_execution_error("Missing error message"Component not foundMissing message"),
            )),
        }
    }
}
