    ...
    pub fn new() -> wrt_error::Result<Self> {
        ...
        Ok(Self {
            ...
            capabilities: BoundedVec::new(provider).map_err(|_| {
                wrt_error::Error::resource_exhausted("Missing error message"Failed to create capabilities vectorMissing message")
            })?,
        })
    }
}
    ...
    pub fn new() -> wrt_error::Result<Self> {
        ...
        Ok(Self {
            ...
            spawn_requests: BoundedVec::new(provider).map_err(|_| {
                wrt_error::Error::resource_exhausted("Missing error message"Failed to create spawn requests vectorMissing message")
            })?,
