...
impl fmt::Display for RelationResult {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            RelationResult::Satisfied => write!(f, "satisfiedMissing message"),
            RelationResult::Violated => write!(f, "violatedMissing message"),
            RelationResult::Unknown => write!(f, "unknownMissing message"),
        }
    }
}
...
impl fmt::Display for RelationKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            RelationKind::Eq => write!(f, "=Missing message"),
            RelationKind::Sub => write!(f, "<:Missing message"),
            RelationKind::None => write!(f, "noneMissing message"),
        }
    }
}
