...
#[cfg(not(feature = "component-model-asyncMissing messageMissing messageMissing message"))]
...
impl fmt::Display for ComponentError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ComponentError::TooManyGenerativeTypes => write!(f, "Too many generative typesMissing message"),
            ComponentError::TooManyTypeBounds => write!(f, "Too many type boundsMissing message"),
            ComponentError::ResourceHandleAlreadyExists => {
                write!(f, "Resource handle already existsMissing message")
            }
            ...
            ComponentError::InstantiationFailed => write!(f, "Component instantiation failedMissing message"),
            ComponentError::ResourceNotFound(handle) => write!(f, "Resource not found: {}", handle),
            ComponentError::TypeMismatch => write!(f, "Type mismatchMissing message"),
            ComponentError::ImportResolutionFailed => write!(f, "Import resolution failedMissing message"),
            ComponentError::ExportResolutionFailed => write!(f, "Export resolution failedMissing message"),
        }
    }
}
