...
impl HelpSystem {
    ...
    fn register_builtin_commands(&mut self) {
        ...
        self.register_command(CommandDoc {
            ...
            description: "Executes unit tests, integration tests, and doc tests with support \
                         for filtering, package-specific testing, and detailed output control.",
            examples: vec![
                CommandExample {
        ...
        self.register_command(CommandDoc {
            ...
            description: "Performs static analysis using clippy, formatting checks, and \
                         other code quality validations with auto-fix capabilities.",
            examples: vec![
                CommandExample {
